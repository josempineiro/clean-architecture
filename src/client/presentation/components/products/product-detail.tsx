  ...
  return (
    <section className="py-10 font-poppins dark:bg-gray-800">
      <div className="max-w-6xl px-4 mx-auto">
        ...
        <img className="object-contain w-full lg:h-full" src="https://www.freeiconspng.com/uploads/no-image-icon-6.png" alt="" />
        ...
        <img className="object-contain w-full lg:h-28" src="https://www.freeiconspng.com/uploads/no-image-icon-6.png" alt="" />
        </a>
        </div>
        </div>
        </div>
