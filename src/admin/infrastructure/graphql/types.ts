...
export function getSdk(
  ...
  return {
    createProduct(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<CreateProductMutation>(
            CreateProductDocumentString,
            variables,
    ...
    product(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<ProductQuery>(ProductDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'product',
    ...
    products(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.rawRequest<ProductsQuery>(ProductsDocumentString, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'products',
